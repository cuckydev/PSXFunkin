...
static const char *funny_messages[][2] = {
	...
	{"SNIPING THE KICKSTARTER", "TAKE IT"},
	{"FUNKIN", "FOREVER"},
	{"WHAT THE HELL", "IS RITZ PSX"},
	{"LIKE PARAPPA", "BUT COOLER"},
	{"WE GOT TANKMEN", "EMMA"}, //Remove when irrelevant
	{"THIS IS A BETA VERSION", "IM WORKING ON IT OKAY"}, //Remove when irrelevant
	{"PICO FUNNY", "PICO FUNNY"},
	{"IM NOT CLOWNACY", "IDIOT"},
	...
	{"TANKMEN WEEK SOURCE", "NEVER"}, //Remove when irrelevant(?)
	{"SHITS UNOFFICIAL", "TELL IT TO CAM"},
	{"SYSCLK", "RANDOM SEED"},
	...
	{"OPEN SOURCE", "FOREVER"},
	{"ITS A PORT", "OF COURSE ITS WORSE"},
	{"I AM FINISHING THIS", "HOLD ME ACCOUNTABLE"} //Remove when irrelevant (lol)
};
