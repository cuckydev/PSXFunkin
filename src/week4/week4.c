...
static void Week4_Load(void)
{
	...
	Gfx_LoadTex(&week4_tex_back0, Overlay_DataRead(), 0); //back0.tim
	Gfx_LoadTex(&week4_tex_back1, Overlay_DataRead(), 0); //back1.tim
	Gfx_LoadTex(&week4_tex_back2, Overlay_DataRead(), 0); //back2.tim
	Gfx_LoadTex(&week4_tex_back3, Overlay_DataRead(), 0); //back3.tim
	Gfx_LoadTex(&week4_tex_back4, Overlay_DataRead(), 0); //back4.tim
